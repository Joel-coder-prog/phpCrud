...
$SQL = "insert into personas (nombre, correo, telefono, estado_civil, hijos, intereses) VALUES ('$nombre', '$correo', '$telefono', '$estado_civil' , '$hijos', '$arregloIntereses')";
$resultado = $mysqlConexion->query($SQL);
$id_insert = $mysqlConexion->insert_id;
